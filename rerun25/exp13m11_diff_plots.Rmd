...
This file creates plots of error diffs in exp13 vs exp11 on test data.
Since exp13 has more scenarios, we'd expect lower test errors (perhaps) and
the differences are exp13 - exp11.
...
plt_ldr_occmean_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                       measure = 'occmean', error = 'mape',
                                       title = 'LDR - mean occupancy',
                                       subtitle = which_subtitle)

ggsave(plt_ldr_occmean_mape_diff, filename = 'exp13/paper_diff_plots/exp13_ldr_occmean_mape_diff.png',
       height = plot_height, width = plot_width)

plt_ldr_occp95_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                      measure = 'occp95', error = 'mape',
                                      title = 'LDR - 95%ile occupancy',
                                      subtitle = which_subtitle)
ggsave(plt_ldr_occp95_mape_diff, filename = 'exp13/paper_diff_plots/exp13_ldr_occp95_mape_diff.png',
       height = plot_height, width = plot_width)

plt_ldr_probblocked_mae_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                       measure = 'probblocked', error = 'mae',
                                       title = 'LDR - probability blocked',
                                       subtitle = which_subtitle)
ggsave(plt_ldr_probblocked_mae_diff, filename = 'exp13/paper_diff_plots/exp13_ldr_probblocked_mae_diff.png',
       height = plot_height, width = plot_width)

plt_ldr_condmeantimeblocked_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                      measure = 'condmeantimeblocked', error = 'mape',
                                      title = 'LDR - conditional mean time blocked',
                                      subtitle = which_subtitle)
ggsave(plt_ldr_condmeantimeblocked_mape_diff, filename = 'exp13/paper_diff_plots/exp13_ldr_condmeantimeblocked_mape_diff.png',
       height = plot_height, width = plot_width)
```
...
plt_pp_occmean_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                       measure = 'occmean', error = 'mape',
                                       title = 'PP - mean occupancy',
                                       subtitle = which_subtitle)
ggsave(plt_pp_occmean_mape_diff, filename = 'exp13/paper_diff_plots/exp13_pp_occmean_mape_diff.png',
       height = plot_height, width = plot_width)

plt_pp_occp95_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                      measure = 'occp95', error = 'mape',
                                      title = 'PP - 95%ile occupancy',
                                      subtitle = which_subtitle)
ggsave(plt_pp_occp95_mape_diff, filename = 'exp13/paper_diff_plots/exp13_pp_occp95_mape_diff.png',
       height = plot_height, width = plot_width)
...
plt_obs_occmean_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                       measure = 'occmean', error = 'mape',
                                       title = 'OBS - mean occupancy',
                                       subtitle = which_subtitle)
ggsave(plt_obs_occmean_mape_diff, filename = 'exp13/paper_diff_plots/exp13_obs_occmean_mape_diff.png',
       height = plot_height, width = plot_width)

obs_occ95_note <- 'Note: Poly model with advanced queueing terms produces non-sensical results due to overfitting.'
plt_obs_occp95_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                      measure = 'occp95', error = 'mape',
                                      title = 'OBS - 95%ile occupancy',
                                      subtitle = which_subtitle, note = NULL,
                                     ylim_ub = 0.15)
ggsave(plt_obs_occp95_mape_diff, filename = 'exp13/paper_diff_plots/exp13_obs_occp95_mape_diff.png',
       height = plot_height, width = plot_width)

plt_obs_probblocked_mae_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                       measure = 'probblocked', error = 'mae',
                                       title = 'OBS - probability blocked',
                                       subtitle = which_subtitle)
ggsave(plt_obs_probblocked_mae_diff, filename = 'exp13/paper_diff_plots/exp13_obs_probblocked_mae_diff.png',
       height = plot_height, width = plot_width)

plt_obs_condmeantimeblocked_mape_diff <- mm_paper_error_diff_plot(exp11_exp13_metrics_agg, unit = which_unit,
                                      measure = 'condmeantimeblocked', error = 'mape',
                                      title = 'OBS - conditional mean time blocked',
                                      subtitle = which_subtitle)
ggsave(plt_obs_condmeantimeblocked_mape_diff, filename = 'exp13/paper_diff_plots/exp13_obs_condmeantimeblocked_mape_diff.png',
       height = plot_height, width = plot_width)
```