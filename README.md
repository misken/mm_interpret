...
For the remote repository, make a github repository named mm_interpet, then do;

```bash
git remote add origin git@github.com:misken/mm_interpet.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── mm_interpet	<- Your notebooks and scripts will live in the main project folder
